...
#
# scores_0 = np.random.beta(2, 5, size=400)
# scores_1 = np.random.beta(5, 2, size=400)
# scores1 = labels * scores_1 + (1 - labels) * scores_0
# scores2 = labels * scores_0 + (1 - labels) * scores_1
# scores3 = np.random.rand(400)
# scores4 = labels
# scores5 = 1-labels
#
# print()
# print(prediction_evaluation(scores1,labels))
# print(prediction_evaluation(scores2,labels))
# print(prediction_evaluation(scores3,labels))
# print(prediction_evaluation(scores4,labels))
# print(prediction_evaluation(scores5,labels))